...
\subsection{\change[GL]{Data layer}{Data} \update{[materials]}}
...
\subsection{\change[GL]{Visualization tier}{Development of Soil Monitor: the dashboard} \update{[methods]}} % Visualization of data and use of soil sealing tools
...
\subsection{ \change[GL]{Processing layer}{Implementation of the processing engine: the soil sealing indicators(/toolbox) at work}}
...
\subsection{Soil Monitor at work on three Italian case studies \remove[GL]{with validation}}
