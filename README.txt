...
%   NJDapacite.sty --> NJD apacite reference package.
%   Lato-fonts (folder) -->   Lato font files 
%   Execute(double click) --> Windows-Lato-fontinstaller.exe from Lato-fonts folder (This EXE file will install fonts to local drive)
...
%
% Simply place WileyNJD-v2.cls, NJDapacite.sty, wileyNJD-APA.bst and wileyNJD-Doc.tex in your systems usual directories
